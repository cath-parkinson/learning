...
summary(evals$score)
sum(evals$score < 3)
ggplot(data = evals, aes(x=score)) + geom_histogram(binwidth = 0.1)
...
evals %>% select(age, gender) %>% ggplot(aes(x=gender, y = age)) + geom_boxplot()
...
ggplot(data=m_bty, aes(x=.resid)) +geom_histogram(binwidth = 0.2)
...
ggplot(data=m_bty_gen, aes(x=.resid)) +geom_histogram(binwidth = 0.2)
