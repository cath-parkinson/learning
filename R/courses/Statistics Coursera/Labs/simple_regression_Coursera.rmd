...
# m4 <- lm(formula = runs ~ at_bats, data = mlb11)
# summary(m4)
# ggplot(data = mlb11, aes(x = at_bats, y = runs)) +
#   geom_point() +
#   stat_smooth(method = "lm", se = FALSE)

m5 <- lm(formula = runs ~ hits, data = mlb11)
summary(m5)
ggplot(data = mlb11, aes(x = hits, y = runs)) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE)

# m6 <- lm(formula = runs ~ wins, data = mlb11)
# summary(m6)
# ggplot(data = mlb11, aes(x = wins, y = runs)) +
#   geom_point() +
#   stat_smooth(method = "lm", se = FALSE)

m7 <- lm(formula = runs ~bat_avg, data = mlb11)
summary(m7)
ggplot(data = mlb11, aes(x = bat_avg, y = runs)) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE)
...
m8 <- lm(formula = runs ~new_obs, data = mlb11)
summary(m8)
ggplot(data = mlb11, aes(x = new_obs, y = runs)) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE)

m10 <- lm(formula = runs ~new_onbase, data = mlb11)
summary(m10)
ggplot(data = mlb11, aes(x = new_onbase, y = runs)) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE)

m10 <- lm(formula = runs ~new_slug, data = mlb11)
summary(m10)
