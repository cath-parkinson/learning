...
us12 %>% group_by(response) %>% summarise(n()/nrow(us12))
...
spain %>% inference(y = response, x=as.factor(year), type = "ht", statistic = "proportion", success = "atheist", method = "theoretical", alternative = "twosided")
...
usall %>% inference(y = response, x=as.factor(year), type = "ht", statistic = "proportion", success = "atheist", method = "theoretical", alternative = "twosided")
