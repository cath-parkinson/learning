...
# Note! Here is not a reactiveVal or a reactivevalue - but it will now behave like one! 
# it's our own manufactured reactive class
...
ReactiveR6 <- R6::R6Class(
  ...
  public = list(
    ...
    reactive = function() {
      ...
      # This returns the object itself, now turned in a reactive! 
      # I tried to chain methods after this by adding an invisible self return, 
      # but I don't think that worked, because I then didn't return a reactive 
      # thing anymore - so this line is key!
